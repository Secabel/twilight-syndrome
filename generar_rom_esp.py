...
CSV_PATH = "assets/csv/guion_principal_esp.csv"
...
# asi que cada idioma tiene su propio arbol assets/graficos/esp/<misma ruta
...
_GRAPHICS_LANG_DIR = "assets/graficos/esp"
...
BANNER_TITLE_ES = "Twilight Syndrome\nToshi Densetsu\n(Spanish)"
# ============================================================================
...
def main():
    ...
    if BANNER_TITLE_ES is not None:
        ...
        # es, asi que hay que cubrir todos para que se vea bien siempre.
        banner = rom.iconBanner
        for lang_index in range(6):
            banner = set_banner_title(banner, lang_index, BANNER_TITLE_ES)
        rom.iconBanner = banner
        print(f"titulo de banner (ES, los 6 idiomas) actualizado: {BANNER_TITLE_ES!r}")
